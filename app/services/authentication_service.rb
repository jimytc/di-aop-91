class AuthenticationService
  def initialize(profile_repo: ProfileRepo.new, hashie: SHA256Adapter.new, failed_counter: FailedCounterAdapter.new, otp: OtpAdapter.new, notifier: SlackAdapter.new, logger: RailsLogger.new)
